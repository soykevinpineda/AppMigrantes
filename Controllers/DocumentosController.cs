...
namespace Migrantes.Controllers
{
    public class DocumentosController : GenericController
    {
...

        {
            ...
            {
                TempData["msjDocsTotales"] = "La persona seleccionada ya tiene todos sus documentos agregados!";
            }
        }
        #endregion
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> GuardarDocumentoEditado(IdentidadPersona identidad)
        {

            var objDocumento = await this._context.IdentidadPersonasDb.AsNoTracking()
            .FirstOrDefaultAsync(x => x.ide_id_persona == identidad.ide_id_persona);
            ...
            if (files.Count > 0)
            {
                ...
                identidad.RutaImagenPortada_A = RutaImagen1 + fileNameA;
                identidad.RutaImagenPortada_B = RutaImagen2 + fileNameB;
            }
            ...
            else
            {
                ...
                identidad.RutaImagenPortada_A = objDocumento.RutaImagenPortada_A;
                identidad.RutaImagenPortada_B = objDocumento.RutaImagenPortada_B;
